This README comes from the [original Repository](https://github.com/NVIDIA/waveglow) and is not up to date.

# Modifications from the original repository
- add linear interpolation of Mel as an option
- add denoiser
- new requirements_3-10.txt
